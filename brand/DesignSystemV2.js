...
export const designTokensV2 = {
  ...
  gradients: {
    ...
    galaxy: 'linear-gradient(135deg, #5f72bd 0%, #667eea 100%)',
    cosmic: 'linear-gradient(135deg, #667eea 0%, #4facfe 50%, #00f2fe 100%)',
    neon: 'linear-gradient(135deg, #fa709a 0%, #4facfe 50%, #00f2fe 100%)',
