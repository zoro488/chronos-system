...
/**
 * Spinner Component - Loading spinner con animación
 */
export const Spinner = ({ size = 'md', className = '', color = 'purple' }) => {
  const sizes = {
    sm: 'w-4 h-4',
    md: 'w-8 h-8',
    lg: 'w-12 h-12',
  ...
  return (
    <div className={cn('inline-block', sizes[size] || sizes.md, className)}>
      <svg
        className={cn('animate-spin', colors[color] || colors.purple)}
...
Spinner.propTypes = {
  size: PropTypes.oneOf(['sm', 'md', 'lg', 'xl', 'large', 'xlarge']),
  className: PropTypes.string,
  color: PropTypes.oneOf(['purple', 'blue', 'green', 'white', 'primary']),
};
